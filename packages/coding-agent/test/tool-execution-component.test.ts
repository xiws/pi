...
describe("ToolExecutionComponent parity", () => {
	...
	test("uses custom renderers for built-in overrides that reuse built-in definition parameters", () => {
		...
		expect(rendered).toContain("override call");
		expect(rendered).toContain("override result");
		expect(rendered).not.toContain("read README.en.md");
	});
	...
	for (const scenario of [
		...
		{
			title: "2AGENTS.md.bak",
			path: join(process.cwd(), ".pi", "2AGENTS.md.bak"),
			content: "Hidden resource instructions",
			compact: "read resource .pi/2AGENTS.md.bak",
		...
		{
			title: "outside 2AGENTS.md.bak",
			path: resolve(process.cwd(), "..", "2AGENTS.md.bak"),
			content: "Hidden outside resource instructions",
			compact: `read resource ${resolve(process.cwd(), "..", "2AGENTS.md.bak").replace(/\\/g, "/")}`,
		...
		},
		{
			...
			compact: "read docs README.en.md",
	...
	for (const scenario of [
		...
		{ title: "Pi documentation", path: getReadmePath(), compact: "read docs README.en.md:120-329" },
	] as const) {
